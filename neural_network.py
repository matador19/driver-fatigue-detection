...
BATCH_SIZE = os.path.join(os.path.dirname(__file__), "dataset")
...
train_loader = torch.utils.data.DataLoader(data,batch_size=BATCH_SIZE,sampler=torch.utils.data.SubsetRandomSampler)
